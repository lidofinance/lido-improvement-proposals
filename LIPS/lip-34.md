...
![Consolidation flow](./assets/lip-34/consolidation_flow.png)
...
![Deposit push model](./assets/lip-34/deposit_push_model.png)
...
![Deposit pull model](./assets/lip-34/deposit_pull_model.png)
...
![Predeposits flow](./assets/lip-34/predeposits_flow.png)
...
![Top-up flow](./assets/lip-34/topup_flow.png)
...
3. Across this list of operators, the Depositor Bot chooses the oldest validators and checks that:
   ...
   - the validator is not a consolidation target;
...
![VEBO report format](./assets/lip-34/vebo_report_format.png)
...
![Deposits reserve example 1](./assets/lip-34/deposits_reserve_example_1.png)
...
![Deposits reserve example 2](./assets/lip-34/deposits_reserve_example_2.png)
...
![Deposits reserve example 3](./assets/lip-34/deposits_reserve_example_3.png)
...
![Module Shares Easy Track algorithm](./assets/lip-34/module_shares_easytrack_algorithm.png)
